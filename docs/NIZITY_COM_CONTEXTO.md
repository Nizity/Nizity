...
| D4 | 2026-09-24 | Stack do Salão: **a da Base**, FastAPI + PostgreSQL + React/TS/Vite (a IA do WhatsApp sugeriu Next.js + Supabase + Vercel, descartado). | Decidido pelo fundador |
| D5 | 2026-09-24 | Ordem de ataque: o Salão entra **agora, junto com o Núcleo**, dividindo o tempo (~15h/semana). As outras frentes da VISAO (arena, plataforma-campo, reator) ficam em segundo plano. | Decidido pelo fundador. Validação com restaurantes pulada (desvio no DIARIO) |
