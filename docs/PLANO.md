...
- [ ] Criar branch `main` a partir do estado aprovado (o repo hoje só tem `claude/oi-b1cjau`).
- [ ] Publicar: GitHub Pages (instruções no README) **ou** Cloudflare Pages, já que o DNS está na Cloudflare. Decidir.
