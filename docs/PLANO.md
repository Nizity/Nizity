...
- [ ] Fatia 5 — Vincular aparelho por QR (aprovada em 2026-09-25): em Equipe, o dono gera um QR por pessoa ("Vincular celular"; para cozinha, tablet e TV); o aparelho que escaneia entra logado como aquela pessoa e fica logado. QR de uso único, válido por 10 min, só na tela do dono, código fora dos logs (fragmento da URL). "Desconectar aparelhos" derruba os acessos da pessoa; desativar a pessoa também. Senha continua como plano B. Sem papel de gerente por enquanto (dono gera). Esboço antes do código; implementa depois da Fatia 4.
- [ ] Cardápio: "Editar item" (lacuna da Fatia 1, achada em 2026-09-25 e aprovada): mudar nome, preço, descrição e categoria sem apagar e recriar. Comandas já lançadas mantêm o preço da hora. Junto com a Fatia 5.
